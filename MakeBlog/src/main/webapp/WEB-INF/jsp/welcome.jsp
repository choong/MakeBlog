	...
	<nav class="navbar navbar-default navbar-fixed-top">
		<div class="container">
			...
			<div class="navbar-header page-scroll">
				...
				<a class="navbar-brand" href="#page-top">${init.title }</a>
			</div>
			...
			<div class="collapse navbar-collapse"
				...
				<ul class="nav navbar-nav navbar-right">
					...
					<li class="page-scroll"><a href="#portfolio">PHOTO</a></li>
					<li class="page-scroll"><a href="#dev">DEV</a></li>
			...
			<div class="row">
				...
				<div class="col-sm-4 portfolio-item">
					<a href="#portfolioModal6" class="portfolio-link"
						...
						</div> <img src="img/portfolio/submarine.png" class="img-responsive" alt="">
					</a>
				</div>
			</div>
		</div>
						...
						<div>
							...
							<div class="row">
								...
								<div class="col-md-2 col-sm-3 text-center">
									<a class="story-img" href="#"><img src="//placehold.it/100"
									...
									<div class="row">
										<div class="col-xs-9">
											...
											<p class="pull-right">
												...
												<a href="#"><i class="fa fa-tag">tag</i></a>
								...
								<div class="col-md-10 col-sm-9">
									...
									<div class="row">
										<div class="col-xs-9">
											...
											<ul class="list-inline">
												<li><a href="#">2 Days Ago</a></li>
												<li><a href="#"><i class="fa fa-comments-o fa-lg"></i> 4 Comments</a></li>
												<li><a href="#"><i class="fa fa-share fa-lg"></i> 34 Shares</a></li>
											</ul>
										</div>
										<div class="col-xs-3"></div>
									</div>
									...
									<div class="row">
										<div class="col-xs-9">
											<p>Lorem ipsum dolor sit amet, consectetur adipiscing
												...
												auctor accumsan. Aliquam in felis sit amet augue.</p>
											<p class="lead">
												<a href="#"><i class="fa fa-hand-pointer-o fa-2x">Read More</i></a>
											</p>
											<p class="pull-right">
												<a href="#"><i class="fa fa-tag">keyword</i></a> 
												<a href="#"><i class="fa fa-tag">tag</i></a>
											...
											<ul class="list-inline">
												<li><a href="#">2 Days Ago</a></li>
												<li><a href="#"><i
														class="glyphicon glyphicon-comment"></i> 4 Comments</a></li>
												<li><a href="#"><i
														class="glyphicon glyphicon-share"></i> 34 Shares</a></li>
											</ul>
										</div>
										<div class="col-xs-3"></div>
									</div>
